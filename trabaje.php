...
// --- (1) Unificar la lógica del formulario ---
// Definir las variables del formulario de "Trabaje con nosotros"
...
if (empty($_POST['nombre']) || empty($_POST['apellido']) || empty($_POST['ciudad']) || empty($_POST['email']) || empty($_POST['area']) || empty($_POST['autoriza'])) {
...
$uploadfile = ''; // Variable para la ruta del archivo subido

// --- (2) Usar un solo bloque try...catch para el envío ---
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Formulario web Gavassa (Trabaje con nosotros)'; // Asunto corregido
    $mail->Body = $mensaje;
...
<body>
    <section id="nosotros">
        <div style="margin-bottom: 20px; margin-left: 50px; margin-right: 50px;" class="titulo-valores">' . $msg . '</div>
        <div class="frase" id="contacto"><img src="img/frase.png" alt=""></div>
    </section>
</body>
</html>';

// --- (4) Limpiar el archivo adjunto si se subió ---
